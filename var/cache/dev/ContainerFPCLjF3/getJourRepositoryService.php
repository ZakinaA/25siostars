 ...
 */
class getJourRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\JourRepository' shared autowired service.
     *
     * @return \App\Repository\JourRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'JourRepository.php';

        return $container->privates['App\\Repository\\JourRepository'] = new \App\Repository\JourRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
