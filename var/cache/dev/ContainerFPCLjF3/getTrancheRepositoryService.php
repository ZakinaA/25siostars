 ...
 */
class getTrancheRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TrancheRepository' shared autowired service.
     *
     * @return \App\Repository\TrancheRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TrancheRepository.php';

        return $container->privates['App\\Repository\\TrancheRepository'] = new \App\Repository\TrancheRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
