 ...
 */
class getProfessionnelRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProfessionnelRepository' shared autowired service.
     *
     * @return \App\Repository\ProfessionnelRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfessionnelRepository.php';

        return $container->privates['App\\Repository\\ProfessionnelRepository'] = new \App\Repository\ProfessionnelRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
