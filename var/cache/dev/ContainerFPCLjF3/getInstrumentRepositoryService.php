...
class getInstrumentRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InstrumentRepository.php';

        return $container->privates['App\\Repository\\InstrumentRepository'] = new \App\Repository\InstrumentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
