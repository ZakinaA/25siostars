 ...
 */
class getTypeInstrumentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeInstrumentRepository' shared autowired service.
     *
     * @return \App\Repository\TypeInstrumentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeInstrumentRepository.php';

        return $container->privates['App\\Repository\\TypeInstrumentRepository'] = new \App\Repository\TypeInstrumentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
