 ...
 */
class getClasseInstrumentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClasseInstrumentRepository' shared autowired service.
     *
     * @return \App\Repository\ClasseInstrumentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClasseInstrumentRepository.php';

        return $container->privates['App\\Repository\\ClasseInstrumentRepository'] = new \App\Repository\ClasseInstrumentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
