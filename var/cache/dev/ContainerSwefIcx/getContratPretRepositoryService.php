 ...
 */
class getContratPretRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ContratPretRepository' shared autowired service.
     *
     * @return \App\Repository\ContratPretRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ContratPretRepository.php';

        return $container->privates['App\\Repository\\ContratPretRepository'] = new \App\Repository\ContratPretRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
