...
class getAccessoireRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AccessoireRepository.php';

        return $container->privates['App\\Repository\\AccessoireRepository'] = new \App\Repository\AccessoireRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
