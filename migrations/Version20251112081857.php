 ...
 */
final class Version20251112081857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, type_id INT DEFAULT NULL, jour_id INT DEFAULT NULL, professeur_id INT NOT NULL, type_instrument_id INT NOT NULL, locaux_id INT DEFAULT NULL, libelle VARCHAR(100) NOT NULL, age_mini DOUBLE PRECISION NOT NULL, age_maxi DOUBLE PRECISION NOT NULL, nb_places INT NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, INDEX IDX_FDCA8C9CC54C8C93 (type_id), INDEX IDX_FDCA8C9C220C6AD0 (jour_id), INDEX IDX_FDCA8C9CBAB22EE9 (professeur_id), INDEX IDX_FDCA8C9C7C1CAAA9 (type_instrument_id), INDEX IDX_FDCA8C9C2ADAA560 (locaux_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE locaux (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, rue VARCHAR(100) NOT NULL, cpos VARCHAR(100) NOT NULL, ville VARCHAR(100) NOT NULL, caracteristiques VARCHAR(255) NOT NULL, cour_dispenses VARCHAR(150) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cours ADD CONSTRAINT FK_FDCA8C9C2ADAA560 FOREIGN KEY (locaux_id) REFERENCES locaux (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cours DROP FOREIGN KEY FK_FDCA8C9C2ADAA560');
